...
<body>
        ...
        <?php
            ...
            $sql="Select * from driver_contact_no";
	...
	<table border="1px solid black">
       ...
       ?>
            ...
            ?>
                ...
                <a href="input.php">ENTER driver_contact_no INFORMATION</a>     <BR> 
				<a href="updateValue.php">EDIT driver_contact_no INFORMATION</a><BR>
				<a href="delete.php">DELETE driver_contact_no INFORMATION</a>
