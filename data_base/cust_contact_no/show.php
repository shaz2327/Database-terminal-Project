...
<body>
        ...
        <?php
            ...
            $sql="Select * from cust_contact_no";
	...
	<table border="1px solid black">
       ...
       ?>
            ...
            ?>
                ...
                <a href="input.php">ENTER cust_contact_no INFORMATION</a>     <BR> 
				<a href="updateValue.php">EDIT cust_contact_no INFORMATION</a><BR>
				<a href="delete.php">DELETE cust_contact_no INFORMATION</a>
				<nav id="sidebar">
    <ul>
