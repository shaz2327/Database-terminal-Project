	...
	<table border="1px solid black">
       ...
       ?>
            ...
            ?>
                ...
                <a href="input.php">ENTER res_paid INFORMATION</a>     <BR> 
				<a href="updateValue.php">EDIT res_paid INFORMATION</a><BR>
				<a href="delete.php">DELETE res_paid INFORMATION</a>
