...
<body>
        ...
        if(isset($_POST['showbtn'])){
            ...
            $sql1="Select * from type_2 where c_id={$c_id}";
    ...
    <h1>Enter type_2 record</h1>
	<form  action="update1.php" method="post">

    <input type="hidden" name="c_id" id="c_id"  value="<?php echo $row['c_id']?>;"  ><br>
    <input type="text" name="designation"  id="designation" value="<?php echo $row['designation'];  ?>"><br>
