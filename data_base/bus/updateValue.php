...
<body>
        ...
        <input type="text" name="bus_id" id="bus_id"  placeholder="Enter bus_id"><br>
        ...
        if(isset($_POST['showbtn'])){
            ...
            $result=mysqli_query($conn,$sql1) or die ("Query not runing");
    ...
    <h1>Enter bus record</h1>
	<form  action="update1.php" method="post">

    <input type="hidden" name="bus_id" id="bus_id"  value="<?php echo $row['bus_id']?>;"  ><br>
    <input type="text" name="route_id"  id="route_id" value="<?php echo $row['route_id'];  ?>"><br>
	<input type="text" name="driver_id" id="driver_id" value="<?php echo $row['driver_id'];  ?>" ><br>
