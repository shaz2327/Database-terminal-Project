...
<body>
	...
	<form  action="action.php" method="post">
        ...
        <input type="text" name="route" id="route"  placeholder="Enter route details"><br>
		<input type="text" name="type"  id="type" placeholder="Enter type"><br>
