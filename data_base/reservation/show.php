	...
	<table border="1px solid black">
       ...
       ?>
            ...
            ?>
                ...
                <a href="input.php">ENTER reservation INFORMATION</a>     <BR> 
				<a href="updateValue.php">EDIT reservation INFORMATION</a><BR>
				<a href="delete.php">DELETE reservation INFORMATION</a>
