...
<body>
        ...
        <input type="text" name="res_id" id="res_id"  placeholder="Enter res_id"><br>
        ...
        if(isset($_POST['showbtn'])){
            ...
            $sql1="Select * from reservation where res_id={$res_id}";
    ...
    <h1>Enter reservation record</h1>
	<form  action="update1.php" method="post">

    <input type="hidden" name="res_id" id="res_id"  value="<?php echo $row['res_id']?>;"  ><br>
    <input type="text" name="c_id"  id="c_id" value="<?php echo $row['c_id'];  ?>"><br>
    <input type="text" name="route_id" id="route_id" value="<?php echo $row['route_id'];  ?>" ><br>
	<input type="text" name="seat_no" id="seat_no" value="<?php echo $row['seat_no'];  ?>" ><br>
